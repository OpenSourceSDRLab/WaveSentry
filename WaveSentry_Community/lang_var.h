...
PROGMEM const char text1_6[] = "WaveSentry";
...
PROGMEM const char text4_20[] = "Firmware: WaveSentry";      //From 20 to 35 add spaces so : is in line like it is now
